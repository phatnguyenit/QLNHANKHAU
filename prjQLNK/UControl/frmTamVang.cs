...
namespace prjQLNK
{
    public partial class frmTamVang : XtraForm
    {
        public frmTamVang()
        {
            InitializeComponent();
        ...
        private void layoutControlGroup3_CustomButtonClick(object sender, DevExpress.XtraBars.Docking2010.BaseButtonEventArgs e)
        {
            ...
            if (e.Button.Properties.Caption == "Xoá")
            {
                ...
                {
                    if (XtraMessageBox.Show("Xóa tạm trú-tạm vắng đang chọn?", "Xóa", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
